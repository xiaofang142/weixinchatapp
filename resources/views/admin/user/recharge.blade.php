                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal " action="{{url('admin/User/setrecharge')}}" method="post">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">recharge</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="recharge"  class="form-control" placeholder="余额">
                                    </div>
                                </div>
                                <div class="form-group">
